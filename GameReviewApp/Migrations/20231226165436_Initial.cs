    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GamesProducers", x => new { x.GameId, x.ProducerId });
                    table.ForeignKey(
                        name: "FK_GamesProducers_Games_GameId",
                        column: x => x.GameId,
                        principalTable: "Games",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GamesProducers_Producers_ProducerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GamesProducers_ProducerId",
                table: "GamesProducers",
                column: "ProducerId");
